...
// im messing with forces i cannot comprehand

foreign import LLVM_C "system:libLLVM.so"
...
foreign LLVM_C {
	...
	FunctionType :: proc(ReturnType: TypeRef, ParamTypes: rawptr, ParamCount: _c.uint, IsVarArg: Bool) -> TypeRef ---
